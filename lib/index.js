...
/***/ function(module, exports, __webpack_require__) {
	...
	var EmitterLite_1 = __webpack_require__(5);
	var d3 = __webpack_require__(6);
	var LPGeoMap = (function (_super) {
	    __extends(LPGeoMap, _super);
	    function LPGeoMap(params) {
	        _super.call(this);
	    ...
	    LPGeoMap.prototype.setData = function (data) {
	        this.geoData = data;
	        return this.render();
	    };
	    LPGeoMap.prototype.setExtraData = function (extraData) {
	        this.extraData = Object.assign({}, extraData);
	        return this;
	    };
	    return LPGeoMap;
	}(EmitterLite_1["default"]));
	exports.__esModule = true;
	exports["default"] = LPGeoMap;
...
/***/ function(module, exports) {
	...
	var EmitterLite = (function () {
	    function EmitterLite() {
	        var _this = this;
	        this._listeners = new Map();
	        EmitterLite._defaultListeners.forEach(function (evtName) {
	            _this._listeners.set(evtName, []);
	        });
	    }
	    EmitterLite.removeListener = function (emit, eventName, handler) {
	        return emit.removeListener(eventName, handler);
	    };
	    EmitterLite.prototype._regListener = function (toPrev, eventName, handler) {
	    ...
	    EmitterLite.prototype._regListenerAndRtnUnregFunc = function (toPrev, eventName, handler) {
	        var _this = this;
	    ...
	    EmitterLite.prototype.on = function (eventName, handler) {
	        return this._regListenerAndRtnUnregFunc(false, eventName, handler);
	    };
	    EmitterLite.prototype.prependOn = function (eventName, handler) {
	        return this._regListenerAndRtnUnregFunc(true, eventName, handler);
	    };
	    EmitterLite.prototype.once = function (eventName, handler) {
	        var ctx = this;
	        function onceWrapperHandler() {
	            var args = [];
	    ...
	    EmitterLite.prototype.addListener = function (eventName, handler) {
	        return this._regListener(false, eventName, handler);
	    };
	    EmitterLite.prototype.prependListener = function (eventName, handler) {
	        return this._regListener(true, eventName, handler);
	    };
	    EmitterLite.prototype.removeListener = function (eventName, handler) {
	        var rtn = false;
	    ...
	    EmitterLite.prototype.removeAllListener = function (eventName) {
	        var rtn = false;
	        if (!eventName) {
	    ...
	    EmitterLite.prototype.emit = function (eventName, args) {
	        try {
	            var listeners = this._listeners.get(eventName);
	            var rtn = false;
	    ...
	    EmitterLite._defaultListeners = ['newListener', 'removeListener', 'error'];
	    return EmitterLite;
	}());
	exports.__esModule = true;
	exports["default"] = EmitterLite;
